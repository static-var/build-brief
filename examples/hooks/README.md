...
- `config.toml` updates that enable `hooks`, enable plugin-bundled hooks with `plugin_hooks`, pre-trust the installed build-brief hook, remove deprecated `codex_hooks`, and turn the plugin on
